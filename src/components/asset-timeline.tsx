        ...
        {assets.map((a, i) => {
          ...
          return (
            <button
              ...
              className={`flex w-full items-center gap-3 px-4 py-2.5 text-left ${i > 0 ? "border-t border-slate-100" : ""} ${
                isSel ? "bg-[#1f3a5f]/[0.06]" : "hover:bg-slate-50"
              }`}
            >
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4">
      <div className="flex flex-wrap items-start justify-between gap-2">
        ...
        <span className="shrink-0 rounded-full bg-sky-50 px-2 py-0.5 text-[11px] text-sky-700">linha do tempo</span>
      </div>
