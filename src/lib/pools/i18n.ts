...
const DICT = {
  ...
  "iv.k.invested": { en: "Invested now", pt: "Investido hoje" },
  "iv.k.invested.h": { en: "capital at work in current pools", pt: "capital trabalhando nos pools atuais" },
  "iv.k.today": { en: "Value today (NAV)", pt: "Valor hoje (NAV)" },
  "iv.k.today.h": { en: "current pools · conservative", pt: "pools atuais · conservador" },
  "iv.k.end": { en: "Projected at end (net)", pt: "Projeção no fim (líq.)" },
  "iv.k.end.h": { en: "current pools · @ market, net", pt: "pools atuais · @ mercado, líq." },
  "iv.k.dist": { en: "Received to date", pt: "Já recebido" },
  "iv.k.dist.h": { en: "everything 4U returned, incl. closed projects", pt: "tudo que a 4U devolveu, incl. encerrados" },
  "iv.k.next": { en: "next", pt: "próx." },
  "iv.k.irr": { en: "Your IRR", pt: "TIR do investidor" },
  "iv.k.irr.h": { en: "whole life · XIRR of YOUR flows + projection", pt: "vida toda · XIRR dos SEUS fluxos + projeção" },
  "iv.k.tvpi": { en: "TVPI today → proj.", pt: "TVPI hoje → proj." },
  "iv.k.tvpi.h": { en: "per $1 out of pocket · net", pt: "por $1 do bolso · líquido" },
  ...
  "st.ev.OPENING": { en: "Opening balance — prior closed projects", pt: "Saldo de abertura — projetos anteriores" },
  ...
  "st.tag.opening": { en: "prior", pt: "anterior" },
