  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-slate-800">Donos</h1>
          <p className="text-sm text-slate-500">{parties.length} cadastrado(s)</p>
        </div>
        <Link
          href="/parties/new"
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-50 text-left text-slate-500">
              <tr>
                ...
                <th className="px-4 py-3 font-medium">Jurisdição fiscal</th>
